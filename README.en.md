...
- `workers/bookforge-api/` — the API proxy that demo calls. **The OpenAI API key lives only as a secret on this Worker** — it is never in the frontend bundle or in this repository (Cloudflare Workers)
